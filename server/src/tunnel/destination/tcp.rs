...
pub struct DestinationTcpConnection {
    destination_tcp_framed: Framed<TcpStream, BytesCodec>,
    destination_address: UnifiedAddress,
}

impl DestinationTcpConnection {
...
impl Stream for DestinationTcpConnection {
...
impl Sink<BytesMut> for DestinationTcpConnection {
